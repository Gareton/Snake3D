...
private:
	void drawStick(const gmt::vec3& upPos, float_t voxelSize, const gmt::mat4& projection, const gmt::mat4& view);
	void drawLeaves(gmt::vec3 upPos, float_t voxelSize, const gmt::mat4& projection, const gmt::mat4& view);
